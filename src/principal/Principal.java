...
//		metodos.metodo1(54161845);
//		
//		//LLAMADA AL METODO 2 Y DECLARACION DEL ARRAY DE STRING
//		String[]arrayLibros = {"2#EL QUIJOTE DE LA MANCHA#16.25",
//						"X#LOS PILARES DE LA TIERRA#18.50",
//						"2#ODISEA EN EL ESPACIO#16.X",
//						"5#LOS PILARES DE LA TIERRA#18.50"};
//		metodos.metodo(arrayLibros);
//		
//		//LLAMADA AL METODO 3
//		metodos.metodo3(3, 4);
//		
...
//
//		};
//		practicas.transformarArrayEnArrayList(visitantesYear);
//		
//		ArrayList<String>cadena = new ArrayList<String>();
//		cadena.add("12234");
//		cadena.add("b3rf");
//		cadena.add("3445");
//		System.out.println(practicas.convierteCadenasANumeros(cadena));
//		
//		HashMap<String, Estudiante> estudiantes = practicas.introMapas();
//		Set<String> claves = estudiantes.keySet();
//		for(String clave : estudiantes.keySet()) {
//			System.out.println(estudiantes.get(clave).getNombre());
//		}
//	
